...
// const deleted = await campground.updateOne({ $pull: { images: { filename: { $in: req.body.deleteImages } } } })
// console.log(deleted)
// }
...
module.exports.updateCampground = async (req, res) => {
    ...
    const destroyed=    await campground.updateOne({ $pull: { images: { filename: { $in: req.body.deleteImages } } } });
